          ...
          <div className="w-full max-w-8xl px-10 py-10">
            ...
            <div className="bg-white/35 w-full p-6 rounded-lg shadow-lg">
              ...
              <div className="flex flex-wrap items-end justify-center gap-6">
                ...
                {/* Search Button */}
                <button 
                  className="bg-blue-600 font-bold text-white px-6 py-2 rounded hover:bg-blue-800 transition shadow-lg"
                  onClick={fetchHotels}
                >
                  Search
                </button>  
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {hotels.map((hotel, index) => (
                      ...
                      >
                        ...
                        {/* Amenities Section with hover popup positioned ABOVE the button */}
